...
export const Evaluation = (props) => {
 ...
 const promedio = Caracteristicas.reduce((total, caracteristica) => total + caracteristica.Nota, 0) / Caracteristicas.length
  ...
  if (promedio >= 90 && promedio <= 100) {
    ...
    categoriaColor = 'green'; // Color verde para categoría "Preparado para multinacionales"
    ...
    categoriaColor = 'blue'; // Color azul para categoría "Preparado para trabajos nacionales"
    ...
    categoriaColor = 'yellow'; // Color amarillo para categoría "Un poco mejor"
  } else {
    ...
    categoriaColor = 'red'; // Color rojo para categoría "No preparado para trabajos"
  }
  ...
  return (
    <>
      <div className='bg-white p-4 md:p-10 rounded-lg shadow-lg ml-10 mr-5 mt-2'>
        ...
        <h3 className={`font-bold text-center text-${categoriaColor}-500 mt-3`}>{categoria}</h3>
      </div>
    </>
  )
}
